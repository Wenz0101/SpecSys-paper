...
\label{sec:4.3.1}
For each model and hardware configuration, \sysname profiles SD speedup across different batch sizes before engine startup and identifies the data-independent, hardware-dependent break-even load $B^{*}$, defined as the largest batch size at which SD achieves a speedup greater than or equal to 1.
