...
Although some existing methods allow the draft length to be reduced to zero, this pseudo-Non-SD mode may still retain SD overhead (details in\autoref{non-sd-overhead}). 
